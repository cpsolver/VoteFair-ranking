#  Test the VoteFairRanking.pm module
...
#  remove-from-cpan-version-begin
	$string_return_value = &VoteFairRanking::votefair_put_input_string( $global_vote_info );
#  remove-from-cpan-version-end
#  uncomment-for-cpan-version-begin
...
#  remove-from-cpan-version-begin
	$string_return_value = &VoteFairRanking::votefair_do_calculations_all_questions( );
#  remove-from-cpan-version-end
#  uncomment-for-cpan-version-begin
...
#  remove-from-cpan-version-begin
	$string_return_value = &VoteFairRanking::votefair_get_output_string( );
#  remove-from-cpan-version-end
#  uncomment-for-cpan-version-begin
